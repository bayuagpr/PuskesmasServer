...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2018 at 04:19 PM
...
INSERT INTO `login_user` (`id_login`, `username`, `password`, `jabatan`) VALUES
('A1', 'admin@pendaftaran', 'admin@pendaftaran', 'Admin Pendaftaran'),
('A2', 'admin@keuangan', 'admin@keuangan', 'Admin Keuangan'),
('A3', 'dokter@umum', 'dokter@umum', 'Dokter Umum'),
('A4', 'dokter@gigi', 'dokter@gigi', 'Dokter Gigi'),
('A5', 'laboran@lab', 'laboran@lab', 'Laboran Lab'),
('A6', 'apoteker@farmasi', 'apoteker@farmasi', 'Apoteker Farmasi');
